...
class ProtocolUtils {
  ...
  static Map<String, int> parseDeviceAddress(String address) {
  ...
  static Map<String, bool> decodeDeviceState(int stateValue) {
    return {
  ...
  static Map<String, bool> decodeEmergencyTestState(int stateValue) {
    return {
